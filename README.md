...
- **What does it do?** It provides all essential supporting circuitry (power regulation, Li-Po 3.7V battery charging, automatic power source switching, high-speed crystal oscillator, SPI flash, USB termination, and ESD/pull-down configuration) to run MicroPython, CircuitPython, Arduino, or bare-metal C/C++ Pico SDK code.
...
4. Integrated **Li-Po 3.7V battery charging** (MCP73831) and **automatic power source switching** (BAT54C Schottky diode) for portable projects.
...
| **Power Input** | USB-C 5V VBUS or Li-Po / Li-Ion 3.7V Battery |
| **Battery Charger** | Microchip MCP73831-2-OT (Single-cell Li-Po/Li-Ion linear charge manager, 4.2V CC/CV) |
| **Power Multiplexing** | BAT54C dual Schottky barrier diode (automatic power source switching between USB and Battery) |
...
The board features a built-in power management circuit designed for both desktop development and portable battery-powered operation:

- **3.7V Li-Po / Li-Ion Battery Support:** Connect any standard 3.7V single-cell Lithium-Polymer (Li-Po) or Lithium-Ion (Li-Ion) battery to the `+BATT` and `GND` pins/pads.
- **Integrated Battery Charging:** The on-board **Microchip MCP73831** charge controller automatically charges the battery when connected to USB-C (5V VBUS) using constant current / constant voltage (CC/CV) up to 4.2V.
- **Automatic Power Source Switching:** A dual common-cathode Schottky diode (**BAT54C**) acts as an automatic power OR-ing switch. When USB-C is plugged in, the board runs directly from USB power while recharging the battery. When USB-C is disconnected, power seamlessly falls over to the battery without interruption or board resets.
...
2. **Solder the Flash (U3), Voltage Regulator (U2), Charger (U4), and Diode (D1):**
   - Solder the MX25L6433 flash chip (SOIC-8), MCP1700 (SOT-23), MCP73831 charger (SOT-23-5), and BAT54C diode (SOT-23). You can do this with normal soldering iron and plenty of flux.
...
| 4 | **10 µF 10V** | C13, C14, C19, C20 | C_0603 (1608 Metric) | [TME LINK](https://www.tme.eu/cz/details/lmk107bj106maltd/kondenzatory-mlcc-smd/taiyo-yuden/lmk107-bj106maltd/) | $0.60 |
...
| 2 | **10 kΩ 1%** | R7, R8, R9 | R_0603 (1608 Metric) | [TME LINK](https://www.tme.eu/cz/details/rc0603jr-0710k/rezistory-smd/yageo/rc0603jr-0710kl/) | $0.15 |
...
| 1 | **MCP73831-2-OT** | U4 | SOT-23-5_HandSoldering | [TME LINK](https://www.tme.eu/cz/details/mcp73831t-2aci_ot/kontrolery-baterii-a-akumulat-obvody/microchip-technology/) | ~$0.75 |
| 1 | **BAT54C** | D1 | SOT-23_Handsoldering | [TME LINK](https://www.tme.eu/cz/details/bat54c-aks/diody-schottky-smd/akyga-semi/aks0016/) | ~$0.07 |
| 1 | **Li-Po 3.7V Battery** | - | - | [TME LINK](https://www.tme.eu/cz/details/aky-lp401235/akumulatory/akyga-battery/aky0475/) | ~$5.7 |
| 1 | **PCB ** | PCB | 2-layer FR-4 (1.6mm, ENIG/HASL) | [JLCPCB](https://jlcpcb.com) | ~$13.45 |
